...
#mass spring
python train_long.py -ni 100 -n_test_traj 25 -n_train_traj 25 -tmax 3.05 -dt 0.05 -srate 0.05 -num_nodes 1 -dname pendulum -noise_std 0 -integrator rk4 -fname expt_a_test1
#python train_pyc_long.py -ni 100 -n_test_traj 25 -n_train_traj 10 -tmax 3.05 -dt 0.05 -srate 0.05 -num_nodes 1 -dname pendulum -noise_std 0.1 -integrator vi4 -fname expt_a_long1
